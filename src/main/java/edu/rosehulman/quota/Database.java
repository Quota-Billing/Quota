...
public class Database {
  ...
  /*
   * POST: /SetConfig Payload: { 'partnerId':'1', 'apiKey':'', 'products': [ { 'productId':'' 'quotas': [ { 'quotaId':'', // tier info here } ] } ] }
   */
  ...
  public void setConfig(String body) {
    ...
    /*
     * jobject = jobject.getAsJsonObject("data"); JsonArray jarray = jobject.getAsJsonArray("translations"); jobject = jarray.get(0).getAsJsonObject(); String result = jobject.get("translatedText").toString();
     */
  }
